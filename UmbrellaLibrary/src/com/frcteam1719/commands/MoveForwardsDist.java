...
public class MoveForwardsDist extends Command {
	...
	public MoveForwardsDist(IDrive system, double distance) {
		this.drive = system;
		...
		SmartDashboard.putData("MoveForwardsDist alignment controller", alignmentController);
		SmartDashboard.putData("MoveForwardsDist distance controller", distanceController);
	}
